import { thousandseparator } from "numberseperatedbythousand";

import Ripple from "../Ripple";
import InfoField from "../InfoField";

export default function ComingSoon(props) {
  const staked = thousandseparator(Math.ceil(props.data.staked));
  const rewards = thousandseparator(Math.ceil(props.data.rewards));
  const stakers = thousandseparator(Math.ceil(props.data.stakers));
